...
var deployJava = function() {
    ...
    var d = {
        ...
        runAppletText: function(p, t, r) {
            var s = null;
            if (r == "undefined" || r == null) {
                r = "1.1"
            }
            var o = r.match(version_regex_strict);
            if (this.returnPage == null) {
        ...
        runApplet:  function(p, t, r) {
       		var o = this.runAppletText(p, t, r);
        	if (o != null) {
        		document.write(o);
        	}
         },
        appletTagText: function(r, w) {
            var o = "<applet ";
            var q = "";
            var t = "</applet>";
            var x = true;
        ...
        versionCheck: function(p) {
            var v = 0;
            var x = p.match(version_regex_with_family_modifier);
            if (x != null) {
                var r = false;
                var u = false;
                var q = new Array();
                for (var t = 1; t < x.length; ++t) {
                    if ((typeof x[t] == "string") && (x[t] != "")) {
                        q[v] = x[t];
                        v++
                    }
                }
        ...
        launchWebStartApplication: function(r) {
            ...
            var q;
            if (p == "MSIE") {
                q = '<object classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93" width="0" height="0"><PARAM name="launchjnlp" value="' + r + '"><PARAM name="docbase" value="' + encodeURIComponent(u) + '"></object>'
            } else {
                if (p == "Netscape Family") {
                    q = '<embed type="application/x-java-applet;jpi-version=' + this.firefoxJavaVersion + '" width="0" height="0" launchjnlp="' + r + '"docbase="' + encodeURIComponent(u) + '" />'
                }
            }
        ...
        allowPlugin: function() {
            this.getBrowser();
            // Fix to omit for Firefox as well
            var o = ("Safari" != this.browserName2 && "Opera" != this.browserName2 && "Firefox" != this.browserName2);
            return o
        },
        getPlugin: function() {
            this.refresh();
        ...
        compareVersionToPattern: function(x, q, r, u) {
            if (x == undefined || q == undefined) {
                return false
            }
            var y = x.match(version_regex_strict);
            if (y != null) {
                var v = 0;
                var z = new Array();
                ...
                var p = Math.min(z.length, q.length);
                if (u) {
                    for (var t = 0; t < p; ++t) {
                        var w = parseInt(z[t]);
                        var o = parseInt(q[t]);
